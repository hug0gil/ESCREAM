...
async function main() {
  ...
  const movies = [
    ...
    { id: 30, title: 'Noroi: La maldición', year: 2008, synopsis: 'Un documentalista investiga una serie de sucesos paranormales que lo llevan a descubrir un ritual demoníaco ancestral.', image: 'noroi.jpg', rating: 4, directorId: 8, productionCompanyId: 16, country: 'JP' },
